...
void input_check(RunParameters *pr, ProblemDefinition *pb)
{
	...
	if ( (pr->strat_statp!=4) && (pr->strat_statp!=6) && (pr->strat_statp!=7) && (pr->strat_statp!=8) && (pr->strat_statp!=9) && (pr->strat_statp!=11) && (pr->strat_statp!=13) && (pr->strat_statp!=14) && (pr->strat_statp!=15) && (pr->strat_statp!=16) && (pr->strat_statp!=99)) {
