...
# for Linux on feng-gps1
	gfortran -std='legacy' -O -o gp ./genetic_code/SQP/MI0L2_c/M.o ./genetic_code/SQP/MI0L2_c/T.o master.o ./genetic_code/tree_functions/vector_derivative_functions.o ./genetic_code/tree_functions/tree_operations.o ./genetic_code/classes/problem_definition.o ./genetic_code/classes/run_parameters.o ./genetic_code/read_input/read_file_new.o ./genetic_code/classes/class_POPULATION.o ./genetic_code/classes/reporter.o ./genetic_code/input_checks/input_check.o ./genetic_code/modules/variable.o ./genetic_code/nodes/nodes.o ./genetic_code/modules/primitives.o -L/usr/lib/gcc/x86_64-redhat-linux/4.0.2/ -lstdc++ -fopenmp
...
master.o: master.cpp
	...
	# normal compilation
	g++ -O3 -c -g master.cpp -o master.o

./genetic_code/SQP/MI0L2_c/M.o: 
	gfortran -std='legacy' -O -c ./genetic_code/SQP/MI0L2_c/MI0L2.FOR -o ./genetic_code/SQP/MI0L2_c/M.o

./genetic_code/SQP/MI0L2_c/T.o: 
	gfortran -fsecond-underscore -O -c ./genetic_code/SQP/MI0L2_c/TI0L2.FOR  -o ./genetic_code/SQP/MI0L2_c/T.o

vector_derivative_functions.o: ./genetic_code/tree_functions/vector_derivative_functions.cpp
	g++ -O3 -c -g ./genetic_code/tree_functions/vector_derivative_functions.cpp -o ./genetic_code/tree_functions/vector_derivative_functions.o

tree_operations.o: ./genetic_code/tree_functions/tree_operations.cpp
	g++ -O3 -c -g ./genetic_code/tree_functions/tree_operations.cpp -o ./genetic_code/tree_functions/tree_operations.o

problem_definition.o: ./genetic_code/classes/problem_definition.cpp
	g++ -O3 -c -g ./genetic_code/classes/problem_definition.cpp -o ./genetic_code/classes/problem_definition.o

run_parameters.o:
	g++ -O3 -c -g ./genetic_code/classes/run_parameters.cpp -o ./genetic_code/classes/run_parameters.o

read_file_new.o: ./genetic_code/read_input/read_file_new.cpp
	g++ -O3  -c -g ./genetic_code/read_input/read_file_new.cpp -o ./genetic_code/read_input/read_file_new.o

population.o:
	g++ -O3 -c -g ./genetic_code/classes/class_POPULATION.cpp -o ./genetic_code/classes/class_POPULATION.o

reporter.o:
	g++ -O3 -c -g ./genetic_code/classes/reporter.cpp -o ./genetic_code/classes/reporter.o

input_check.o: 
	g++ -O3 -c -g ./genetic_code/input_checks/input_check.cpp -o ./genetic_code/input_checks/input_check.o

variable.o: 
	g++ -O3 -c -g ./genetic_code/modules/variable.cpp -o ./genetic_code/modules/variable.o

nodes.o:
	g++ -O3 -c -g ./genetic_code/nodes/nodes.cpp -o ./genetic_code/nodes/nodes.o

primitives.o:
	g++ -O3 -c -g ./genetic_code/modules/primitives.cpp -o ./genetic_code/modules/primitives.o
